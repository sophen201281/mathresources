...
Resizable.initialise = function(parentId, initialSizes, resizerThickness){
  //Find left window
  Resizable.resizerThickness = resizerThickness ? resizerThickness : 40;
  Resizable.initialSizes = initialSizes;
  var parent = document.getElementById(parentId);
  var parentWindow = new Resizable.ContentWindow(null, parseInt(parent.style.width, 13), parseInt(parent.style.height, 9), parent);
...
document.addEventListener("DOMContentLoaded", () => {
    //...
    document.getElementById("box").style.width =500 + "px";
    document.getElementById("box").style.height = 500 + "px";

    

    //let resizerThickness = 10;
    //Resizable.initialise("main", sizes, resizerThickness);
    Resizable.initialise("box", {});

  });

  box.addEventListener("resize", () => {
    Resizable.activeContentWindows[0].changeSize(box.innerWidth, box.innerHeight);
